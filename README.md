...
This is a fork of [graphdeco-inria/gaussian-splatting](https://github.com/graphdeco-inria/gaussian-splatting) with some modifications (currently focused on dependency resolution and updates). See [INSTALL.md](INSTALL.md) for installation instructions.
